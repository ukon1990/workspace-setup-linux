...
default_ports=(1433 4200 4202 5100 5110 5120 5130 5201 5221 5241 5251 5261 5266 5281 5291 64047 15185 17107 19189 20062 21216 22156)

usage() {
  echo "Usage: closeports <port> [<port> ...]" >&2
  echo "Closes any processes listening on the given TCP/UDP ports." >&2
  echo "If no ports are provided, defaults are used: ${default_ports[*]}." >&2
}
...
if [ ${#ports_to_close[@]} -eq 0 ]; then
  ports_to_close=("${default_ports[@]}")
  echo "No ports provided; using defaults: ${ports_to_close[*]}" >&2
fi
